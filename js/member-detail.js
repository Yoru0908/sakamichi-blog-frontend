...
window.MemberDetail = {
    ...
    container.innerHTML = `
      ...
      <div class="detail-header">
        <div class="detail-header-content">
          ...
          <div id="detailBreadcrumb" style="color: #666; font-size: 14px;">
            <!-- 面包屑导航 -->
          </div>
        </div>
      </div>
  ...
  renderBlogDetail(blog, memberName, groupKey) {
    ...
    if (blog.translated_content) {
      ...
      contentEl.innerHTML = '<p style="color: #999;">暂无内容</p>';
    }
  ...
  renderRecentEntries(memberName) {
    ...
    if (recentBlogs.length === 0) {
      entriesEl.innerHTML = '<li style="padding: 12px 0; color: #999;">暂无博客</li>';
      return;
    }
